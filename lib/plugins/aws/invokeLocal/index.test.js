...
describe('AwsInvokeLocal', () => {
  ...
  describe('#extendedValidate()', () => {
    ...
    it('should not reject when there are no input data', () => {
    ...
    it('it should reject if function is not provided', () => {
      serverless.service.functions = null;
      return expect(awsInvokeLocal.extendedValidate()).to.be.rejectedWith(Error);
    });
    ...
    it('it should reject if service path is not set', () => {
      ...
      return expect(awsInvokeLocal.extendedValidate())
